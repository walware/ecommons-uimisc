...
public class VerticalAlignmentPicker extends Composite {
    ...
    public VerticalAlignmentPicker(final Composite parent, final VerticalAlignmentEnum alignment) {
        super(parent, SWT.NONE);
        setLayout(new RowLayout());

        this.combo= new Combo(this, SWT.READ_ONLY | SWT.DROP_DOWN);
        this.combo.setItems(new String[] { Messages.getString("VerticalAlignmentPicker.top"), Messages.getString("VerticalAlignmentPicker.middle"), Messages.getString("VerticalAlignmentPicker.bottom") }); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

        update(alignment);
    }

    private void update(final VerticalAlignmentEnum alignment) {
    ...
    public void setSelectedAlignment(final VerticalAlignmentEnum verticalAlignment) {
