...
public class BlendedBackgroundPainter extends TextPainter {
	 ...
	 *
	 * @param cell
	 *            the {@link de.walware.ecommons.waltable.layer.cell.ForwardLayerCell} to get a background colour for.
	 * @param configRegistry
	 *            an {@link de.walware.ecommons.waltable.config.IConfigRegistry}.
	 * @param baseColor
