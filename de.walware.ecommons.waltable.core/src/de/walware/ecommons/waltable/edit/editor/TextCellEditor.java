...
import de.walware.ecommons.waltable.edit.config.RenderErrorHandling;
...
public class TextCellEditor extends AbstractCellEditor {
	 ...
	 */
	public TextCellEditor(final boolean commitOnUpDown) {
	 ...
	 * 			committed after pressing enter.
	 */
	public TextCellEditor(final boolean commitOnUpDown, final boolean moveSelectionOnEnter) {
	...
	protected Control activateCell(final Composite parent, final Object originalCanonicalValue) {
		...
		if (this.inputConversionErrorHandler instanceof RenderErrorHandling) {
			final IStyle conversionErrorStyle= this.configRegistry.getConfigAttribute(
		...
		if (this.inputValidationErrorHandler instanceof RenderErrorHandling) {
			final IStyle validationErrorStyle= this.configRegistry.getConfigAttribute(
		...
		textControl.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(final KeyEvent event) {
				if (TextCellEditor.this.commitOnEnter && 
					...
					Direction move= null;
					if (TextCellEditor.this.moveSelectionOnEnter && TextCellEditor.this.editMode == EditMode.INLINE) {
					...
					if (TextCellEditor.this.editMode == EditMode.DIALOG) {
						parent.forceFocus();
					}
				} 
				...
				else if (TextCellEditor.this.commitOnUpDown && TextCellEditor.this.editMode == EditMode.INLINE) {
			...
			public void keyReleased(final KeyEvent e) {
				try {
					...
					final Object canonicalValue= getCanonicalValue(TextCellEditor.this.inputConversionErrorHandler); 
	 ...
	 */
	public void setErrorDecorationText(final String errorText) {
