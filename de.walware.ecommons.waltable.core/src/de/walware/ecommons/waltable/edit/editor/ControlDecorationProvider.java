...
public class ControlDecorationProvider {
	 ...
	 */
	public ControlDecorationProvider(final String fieldDecorationId) {
	 ...
	 */
	public void showErrorDecorationHover(final String errorText) {
		if (this.errorDecoration != null) {
	 ...
	 */
	private ControlDecoration newControlDecoration(final Control controlToDecorate, final Image errorImage, final int position) {
