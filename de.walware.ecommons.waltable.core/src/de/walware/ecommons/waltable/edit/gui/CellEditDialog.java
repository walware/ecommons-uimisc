...
public class CellEditDialog extends Dialog implements ICellEditDialog {
	 ...
	 */
	public CellEditDialog(final Shell parentShell,
	...
	protected void configureShell(final Shell newShell) {
		...
		if (this.editDialogSettings != null) {
			...
			final Object settingsShellImage= this.editDialogSettings.get(DIALOG_SHELL_ICON);
	...
	protected Point getInitialLocation(final Point initialSize) {
		if (this.editDialogSettings != null) {
			final Object settingsLocation= this.editDialogSettings.get(DIALOG_SHELL_LOCATION);
	...
	protected Point getInitialSize() {
		if (this.editDialogSettings != null) {
			final Object settingsSize= this.editDialogSettings.get(DIALOG_SHELL_SIZE);
	...
	protected Control createDialogArea(final Composite parent) {
		...
		final GridLayout panelLayout= new GridLayout(1, true);
		...
		if (this.editDialogSettings != null && this.editDialogSettings.containsKey(DIALOG_MESSAGE)) {
			...
			final Label customMessageLabel= new Label(panel, SWT.NONE);
	...
	public void setDialogSettings(final Map<String, Object> editDialogSettings) {
		...
		if (this.editDialogSettings != null) {
			final Object settingsResizable= this.editDialogSettings.get(DIALOG_SHELL_RESIZABLE);
