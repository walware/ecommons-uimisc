...
public interface ICellEditDialog {
	 ...
	 * Will be interpreted by {@CellEditDialog#getInitialLocation(LPoint)}
	 ...
	 * 			the data model. By default {@link de.walware.ecommons.waltable.edit.EditTypeEnum#SET} is returned, which
	 ...
	 * the key {@link de.walware.ecommons.waltable.edit.EditConfigAttributes#EDIT_DIALOG_SETTINGS}. The keys that are valid
