...
public abstract class AbstractCellEditor implements ICellEditor {
	 ...
	 * @see AbstractCellEditor#commit(Direction, boolean)
	 */
	protected final boolean commit(Direction direction) {
	 ...
	 */
	protected final boolean commit(Direction direction, boolean closeAfterCommit) {
		if (editHandler != null) {
