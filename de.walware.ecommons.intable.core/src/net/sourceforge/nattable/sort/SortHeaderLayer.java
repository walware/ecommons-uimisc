...
import net.sourceforge.nattable.sort.command.ClearSortCommandHandler;
import net.sourceforge.nattable.sort.command.SortColumnCommandHandler;
	...
	public LabelStack getConfigLabelsByPosition(int columnPosition, int rowPosition) {
		...
		if (sortModel != null) {
			...
			if (sortModel.isColumnIndexSorted(columnIndex)) {
				...
				case ASC:
					configLabels.addLabel(SortHeaderLayer.SORT_UP_CONFIG_TYPE);
					break;
				case DESC:
					configLabels.addLabel(SortHeaderLayer.SORT_DOWN_CONFIG_TYPE);
					break;
				}
				String sortConfig = SortHeaderLayer.SORT_SEQ_CONFIG_TYPE + sortModel.getSortOrder(columnIndex);
