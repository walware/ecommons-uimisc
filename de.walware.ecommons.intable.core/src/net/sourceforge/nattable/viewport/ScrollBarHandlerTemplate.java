...
public abstract class ScrollBarHandlerTemplate implements Listener {
	...
	void recalculateScrollBarSize() {
		...
		int max = getScrollableLayerSpan() + getScrollBarOverhang();
		if (! scrollBar.isDisposed()) {
			scrollBar.setMaximum(max);
		}
		
		final int viewportWindowSpan = getViewportWindowSpan();
	...
	abstract Direction scrollDirectionForEventDetail(int eventDetail);
