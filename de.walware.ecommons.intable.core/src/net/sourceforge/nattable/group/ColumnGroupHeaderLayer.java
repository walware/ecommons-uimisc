...
public class ColumnGroupHeaderLayer extends AbstractLayerTransform {
	...
	private int groupHeaderRowPosition;
	...
	public int getRowIndexByPosition(int rowPosition) {
		if (rowPosition == getGroupHeaderRowPostion()) {
			return rowPosition;
		} else {
	...
	public void setRowHeight(int rowHeight) {
		this.rowHeightConfig.setSize(getGroupHeaderRowPostion(), rowHeight);
	}
	...
	public int getRowPositionByY(int y) {
		int row0Height = getRowHeightByPosition(getGroupHeaderRowPostion());
		if (y < row0Height) {
			return 0;
		} else {
	...
	public LayerCell getCellByPosition(int columnPosition, int rowPosition) {
		...
		if (model.isPartOfAGroup(bodyColumnIndex)) {
			...
			LayerCell cell = columnHeaderLayer.getCellByPosition(columnPosition, getGroupHeaderRowPostion());
			if (cell != null) {
	...
	public String getDisplayModeByPosition(int columnPosition, int rowPosition) {
		int columnIndex = getColumnIndexByPosition(columnPosition);
		if (rowPosition == getGroupHeaderRowPostion() && model.isPartOfAGroup(columnIndex)) {
	...
	public Object getDataValueByPosition(int columnPosition, int rowPosition) {
		...
		if (rowPosition == getGroupHeaderRowPostion() && model.isPartOfAGroup(columnIndex)) {
			...
			return columnHeaderLayer.getDataValueByPosition(columnPosition, getGroupHeaderRowPostion());
		}
	}
	...
	public LabelStack getRegionLabelsByXY(int x, int y) {
		...
		if (model.isPartOfAGroup(columnIndex) && y < getRowHeightByPosition(getGroupHeaderRowPostion())) {
			return new LabelStack(GridRegion.COLUMN_GROUP_HEADER);
		} else {
			return columnHeaderLayer.getRegionLabelsByXY(x, y - getRowHeightByPosition(getGroupHeaderRowPostion()));
		}
	}
	 ...
	 * @return "0" by default
	 */
	public int getGroupHeaderRowPostion() {
		return groupHeaderRowPosition;
	}
	
	public void setGroupHeaderRowPosition(int groupHeaderRowPosition) {
		this.groupHeaderRowPosition = groupHeaderRowPosition;
	}
