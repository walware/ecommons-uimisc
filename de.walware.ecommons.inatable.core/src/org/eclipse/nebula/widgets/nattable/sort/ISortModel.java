...
public interface ISortModel {
	 ...
	 */
	public boolean isColumnIndexSorted(long columnIndex);

	/**
	 * @return the direction in which the column with the given index is
	 * currently sorted
	 */
	public SortDirectionEnum getSortDirection(long columnIndex);
	 ...
	 * for index 6 is 1.
	 */
	public int getSortOrder(long columnIndex);
	
	public List<Comparator> getComparatorsForColumnIndex(long columnIndex);
	 ...
	 */
	public void sort(long columnIndex, SortDirectionEnum sortDirection, boolean accumulate);
