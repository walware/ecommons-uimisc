...
public class StylePersistor {
	...
	protected static void saveHAlign(String prefix, Properties properties, HorizontalAlignment hAlign) {
		if (hAlign == null) {
			return;
		}
	...
	public static Style loadStyle(String prefix, Properties properties) {
		...
		HorizontalAlignment hAlign = loadHAlignment(hAlignPrefix, properties);
		if (hAlign != null) {
	...
	private static HorizontalAlignment loadHAlignment(String hAlignPrefix, Properties properties) {
