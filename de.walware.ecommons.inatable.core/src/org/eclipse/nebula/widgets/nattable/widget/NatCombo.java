...
public class NatCombo extends Composite {
	...
	private void createTextControl() {
		text = new Text(this, CellStyleUtil.getHorizontalAlignmentSWT(cellStyle, SWT.NONE));
	...
	private void createDropdownControl() {
		...
		dropdownList = new List(dropdownShell, SWT.V_SCROLL | CellStyleUtil.getHorizontalAlignmentSWT(cellStyle, SWT.NONE));
